...
- ≤500 (153심볼): **153/153 YES**. 답한 단계의 벽시계 합 279.8초(종전 열은 예산 300 고정의 합 13,000.9초를 재고 있었다). 예산은 151심볼이 5, 2심볼이 20. 옛 표의 1위 `$bin_minus`(1800.5초)는 예산 5에 5.6초로 답한다.
- \>500 (124심볼): **124/124 YES, 전부 예산 5, 합 479.6초.** 폐기된 모듈러-B 축의 MAYBE 11건이
