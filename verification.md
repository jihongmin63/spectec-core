...
> 후에도 모두 YES다.
>
> **범위**: 슬라이스 가능한 심볼은 574개고 이 표는 그중 **317행**이다. 나머지는 미측정 —
...
**termination**: YES 307 / 308 측정 · TIMEOUT 1 · 비종료 후보 0 · 규칙 0(DEGENERATE, AProVE 미실행) 9. TIMEOUT 1건은 최상위 관계 `Program_inst`(69,126규칙)로, 20,480초 예산 내 미완일 뿐 비종료 witness가 아니다(도구 예산 한계).
**confluence**: YES 162 · - 137 · TIMEOUT 12 · YES* 5 · MAYBE 1.
...
| 316 | `Program_ok` | 67634 | - | YES (≥20480s) |
| 317 | `Program_inst` | 69126 | - | TIMEOUT (>20480s) |
